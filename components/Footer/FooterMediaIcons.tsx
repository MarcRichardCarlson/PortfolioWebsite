      ...
      {urls.map(({ url, icon, alt }, index) =>
        isValidUrl(url) ? (
          <a
            ...
            className="min-w-[150px] flex justify-center items-center dark:bg-dark-grey bg-light-grey dark:hover:bg-true-blue hover:bg-true-blue cursor-pointer flex flex-row gap-2 p-2 rounded-xl transition-colors duration-300 ease-in-out"
          >
