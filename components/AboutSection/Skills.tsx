...
const Skills: React.FC<SkillsProps> = ({ columnNames }) => {
    ...
    return (
        <div className="overflow-hidden flex flex-col justify-center gap-8 min-w-64 w-full px-4 sm:px-6 md:px-8 bg-light-grey dark:bg-dark-grey p-6 md:p-8 rounded-xl shadow-custom-shadow hover:shadow-lg transition-shadow duration-300 font-montserrat">
