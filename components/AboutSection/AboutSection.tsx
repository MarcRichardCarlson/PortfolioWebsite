    ...
    return (
        <div className="bg-black-soil min-h-screen flex justify-center items-center">
            <div className="max-w-[1400px] mx-auto">
                <section className="w-full w-full flex flex-col xl:flex-row justify-around px-4 sm:px-6 md:px-8 gap-16 xl:gap-0 pt-24 xl:pt-0">
                    <div className="w-full xl:w-1/2 flex flex-col gap-2 justify-start">
                        ...
                        <span className="text-xs sm:text-sm md:text-base lg:text-lg font-inter text-white-grey leading-relaxed">
                            {t("about-text")}
                        </span>
